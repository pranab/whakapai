...
class Candidate(object):
	...
	def build(self, comp, size):
		...
		Parameters
			...
			size : max size for variable size solution
		"""
		status = True
...
class BaseOptimizer(object):
	...
	def bestFromMultiMutate(cand, maxTry, numIter):
		...
		Parameters
			...
			maxTry : max no of tries
			numIter : no of iterations
		"""
		bestSoln = cand
		bestCost = cand.cost
		foundBetter = False
	...
	def localSearch(self, cand):
		"""
		performs local search centered around a good solution and return best solution
...
class PopulationBasedOptimizer(BaseOptimizer):
	...
	def findBest(self, candList):
		...
		Parameters
			candList : list of candidate solutions
		"""
		bestCost = None
		bestSoln = None
	...
	def findFitnessDistr(self):
		"""
		calculates fitness distribution of candidates in pool
		"""
	...
	def findMultBest(self, candList, size, preSorted=False):
		...
		Parameters
			candList : list of candidate solutions
			size : no of top candidate solutions
			preSorted = true if pre sorted
		"""
		if not preSorted:
			self.sort()
	...
	def fitnessDistrSelect(self, useCachedDistr):
		...
		Parameters
			useCachedDistr : true if cached distribution to be used
		"""
	...
	def multiPurge(self, size): 
		...
		Parameters
			size : no of solutions to be purged
		"""
